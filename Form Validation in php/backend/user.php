<?php require_once('../components/header.php') ?>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                $user_view = "SELECT ID, Name, Email FROM users";

                                $user_query = mysqli_query($db_connect, $user_view);
                                ...
                                ?>
                                    ...
                                    <div class="card-header">
                                        <h5 class="card-title">Total Number Of Users <span class="text-danger fs-4"><?= $total_assoc ?></span> </h5>
                                    </div>
                                    <div class="card-body">
                                        <ul class="widget-list-content list-unstyled">

                                        <?php foreach ($user_query as $key => $data) { ?>


                                            <li class="widget-list-item widget-list-item-green">
                                                <span class="widget-list-item-icon fw-bold bg-warning" style="padding-top: 8px; color: black; font-size: 20px;"><?= ($key + 1 )?></span>
