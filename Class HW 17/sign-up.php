    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                <form action="sign-up-backend.php" method="post">
                    ...
                    <input type="password" class="form-control m-b-md" placeholder="Enter Confirm-Password" name="confirm-password" value="<?php
                    if(isset($_SESSION['confirm_password'])){
                        echo $_SESSION['confirm_password'];
                    }
                    ?>">
                    <?php
                    if (isset($_SESSION["confirm-password-error"])) { ?>
                        <div class="alert alert-danger" role="alert">
                            confirm password required
                        </div>
                    <?php
                    }
                    if (isset($_SESSION["miss-match"])) {
                    ?>
                        <div class="alert alert-warning" role="alert">
                    ...
                    if (isset($_SESSION["password_pregma"])) {
                    ?>
                        <div class="alert alert-warning" role="alert">
                            <?php
                            echo $_SESSION['password_pregma'];
                            ?>
                        </div>
                    <?php
                    }
