...
$photo_query = "SELECT photo FROM users WHERE email='$email'";
$after_assoc = mysqli_fetch_assoc(mysqli_query($data_connect, $photo_query))['photo'];
?>
        ...
        <div class="app-sidebar">
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="components/images\<?= $after_assoc;?>">
                        <span class="activity-indicator"></span>
                        <span class="user-info-text">
                            <?php
                            if(isset($_SESSION['user_name'])){
                            ?>
                        <span class="user-state-info">user name is : <?php echo $_SESSION['user_name']?></span><br>
                            <?php
                            }
                            ?>
                            <?php
                            ...
                            ?>
                        <span>user id is : <?php echo $_SESSION['user_id']?></span><br>
                            <?php
                            }
                            ?>
                        <br><span class="user-state-info">On a call</span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="service.php" class="active"><i class="material-icons-two-tone">design_services</i>service</a>
                    </li>
                    <li>
                        <a href="portfolio.php" class="active"><i class="material-icons-two-tone">import_contacts</i>portfolio</a>
                    </li>
                    <li>
                        <a href="facts.php" class="active"><i class="material-icons-two-tone">forum</i>Facts</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
                                    ...
                                    if(isset($_SESSION['user_name'])){
                                    ?>
                                    <h4>user name is : <?php echo $_SESSION['user_name']?></h4>
                                    <?php
                                    }
                                    ?>
                                    <?php
                                    if(isset($_SESSION['user_id'])){
                                    ?>
                                    <h5>user id is : <?php echo $_SESSION['user_id']?></h5>
                                    <?php
                                    }
                                    ?>
                                </div>
