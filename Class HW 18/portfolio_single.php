...
$port_assoc = mysqli_fetch_assoc($port_final);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="components/portfolio-images\<?=$port_assoc['port_photo']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$port_assoc['port_heading']?></h2>
                                    <p><?=$port_assoc['port_des']?></p>
