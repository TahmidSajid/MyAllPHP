...
$banner_query = "SELECT * FROM banner_elements;";
$banner_query_apply = mysqli_query($data_connect, $banner_query);
$banner_assoc = mysqli_fetch_assoc($banner_query_apply);
$profile_greeting = $banner_assoc['greeting'];
$profile_name = $banner_assoc['name'];
$profile_description = $banner_assoc['description'];
$profile_photo = $banner_assoc['photo'];
$status_query = "SELECT * FROM services where status='active';";
$status_impliment = mysqli_query($data_connect, $status_query);
$port_query = "SELECT * FROM portfolio;";
$port_final = mysqli_query($data_connect, $port_query);
$Facts_query = "SELECT * FROM facts;";
$Facts_final = mysqli_query($data_connect, $Facts_query);
?>
    ...
    <main>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            <h6 class="wow fadeInUp" data-wow-delay="0.2s"><?= $profile_greeting ?></h6>
                            <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am <?= $profile_name ?></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.6s"><?= $profile_description ?></p>
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="banner-img text-right">
                            <img src="components/images\<?= $profile_photo ?>" style="height:700px!important;width:auto;" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="service" class="services-area pt-120 pb-50">
            <div class="container">
                ...
                <div class="row">
                    <?php
                    foreach ($status_impliment as $value) { ?>
        ...
        <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
            <div class="container">
                ...
                <div class="row">
                    <?php foreach ($port_final as $value) { ?>

                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
                                <div class="speaker-thumb">
                                    <img src="components\portfolio-images/<?= $value['port_photo'] ?>" alt="img">
                                </div>
                                <div class="speaker-overlay">
                                    <span><?= $value['type'] ?></span>
                                    <h4><a href="portfolio_single.php?id=<?= $value['id'] ?>"><?= $value['name'] ?></a></h4>
                                    <a href="portfolio_single.php?id=<?= $value['id'] ?>" class="arrow-btn">More information <span></span></a>
                                </div>
                            </div>
                        </div>
                    <?php
            ...
            <div class="container">
                <div class="fact-wrap">
                    <div class="row justify-content-between">
                        <?php
                        foreach ($Facts_final as $key => $value) { ?>
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                    ...
                                    <div class="fact-content">
                                        <h2><span class="count"><?=$value['count']?></span></h2>
                                        <span><?=$value['facts_name']?></span>
                                    </div>
                                </div>
                            </div>
                        <?php
